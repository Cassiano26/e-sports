  ...
  return (
    <div className='relative bg-primary-80 h-[776px]'>
      ...
      <div className='flex flex-col gap-12 absolute z-30 top-[106px] left-[168px] w-[554px]'>
        ...
        <h1 className='font-semibold text-white text-6xl uppercase'>tournaments</h1>
        <p className='text-2xl font-normal text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris semper nulla est, sollicitudin et faucibus integer.</p>
        <button className='bg-primary-50 rounded-3xl w-60 h-14 font-semibold text-2xl text-white mt-4'>Register Now</button>
      </div>
